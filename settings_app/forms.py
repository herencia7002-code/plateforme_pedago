...
class PlatformSettingsForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ["nom_plateforme", "email", "telephone", "autoriser_inscriptions", "validation_documents", "autoriser_commentaires",]
        widgets = {
            "nom_plateforme": forms.TextInput(attrs={ "class": "form-control",  "placeholder": "Nom de la plateforme",}),
